...
export class ExamService {
  ...
  getExams(filters: ExamFilters = {}, context?: HttpContext): Observable<PaginatedResponse<Exam>> {
    ...
    return this.http.get<PaginatedResponse<Exam>>(this.baseUrl, { params, context });
  }
